        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow h-100">
                    <div class="card-header" style="background-color:#1B4332;">
                    ...
                    <div class="card-body">
                        <ol>
                            <h4>Misi</h4>
                            <li>1. Menyajikan minuman alpukat kocok dengan bahan berkualitas, higienis, dan cita rasa yang konsisten.</li>
            ...
            <div class="card-body text-center">
                <img src="assets_user/images/struktur.png" alt="Struktur Organisasi Rockpukat" class="img-fluid struktur-organisasi">
            </div>
    </section>
...
<a href="{{ route('register') }}" class="btn btn-success active">Daftar</a>
    ...
    <div class="col-lg-4 mb-4">
        <div class="card shadow h-100 text-center">
            <img src="assets_user/images/buy5get1.png" class="card-img-top" alt="Promo Hemat">
            <div class="card-body">
                <h4>Promo BUY 1 GET 1</h4>
                <p>Nikmati penawaran menarik yang hanya didapatkan oleh akun baru.</p>
                <a href="katalog.php" class="btn btn-success">Lihat Promo</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4 mb-4">
        <div class="card shadow h-100 text-center">
            <img src="assets_user/images/buy1get1.png" class="card-img-top" alt="Menu Favorit">
            <div class="card-body">
    ...
    <div class="col-lg-4 mb-4">
        <div class="card shadow h-100 text-center">
            <img src="assets_user/images/logo.jpg" class="card-img-top" alt="Promo Spesial">
            <div class="card-body">
                <h4>Promo Spesial</h4>
    ...
    <div class="container">
        ...
        <div class="row align-items-center mb-5">
            ...
            <div class="col-lg-5">
                <img src="assets_user/images/logo.jpg"
