                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card shadow h-100">
                            ...
                            <div class="card-body text-center">
                                <img src="assets_user/images/struktur.png" alt="Struktur Organisasi Rockpukat"
                                    class="img-fluid struktur-organisasi">
                            </div>
    </section>
    ...
    <section class="section" id="info">
        ...
        <div class="container">
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-5">
                    <img src="assets_user/images/logo.jpg" class="img-fluid rounded shadow" alt="Rockpukat">
                </div>
